...
exports.run = async(client, message, args) => { //Westron Botlist
if (message.channel.type !== "text") return;
const limit = args[0] ? args[0] : 0;
  if(!limit) {
              var embed = new Discord.MessageEmbed()
                .setDescription(`✅ Doğru Kullanım: \`*slowmode <sure>\``) // x! olan yere bot Prefix
                .setColor('RANDOM')
                .setTimestamp()
...
exports.help = {
  name: 'slow-mode',
  description: 'Sohbete yazma sınır (süre) ekler.', //Westron Botlist
